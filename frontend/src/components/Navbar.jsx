...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* 1. TOP NAVBAR (Visible at top of desktop, and always visible on mobile) */}
      <nav 
        className={`glass-navbar z-50 fixed top-0 left-0 w-full h-16 flex items-center transition-all duration-300 ${
          scrolled ? 'md:opacity-0 md:pointer-events-none' : 'md:opacity-100 md:pointer-events-auto'
        }`}
      >

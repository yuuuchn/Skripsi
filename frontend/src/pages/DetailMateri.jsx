...
export default function DetailMateri() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      {/* Breadcrumb */}
      <nav className="flex items-center gap-1.5 text-xs font-bold text-[var(--color-text-secondary)] uppercase tracking-wider mb-5 animate-fade-in">
      ...
      {/* Header */}
      <div className={`rounded-2xl bg-gradient-to-r ${gradientClass} p-8 md:p-10 mb-8 text-white relative overflow-hidden shadow-lg animate-fade-in-up`}>
        {/* Decorative elements */}
      ...
      <div className="space-y-6 mb-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        {materi.id === 1 && (
      ...
      <div className="card p-6 md:p-10 mb-8 border-slate-200/60 shadow-sm animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
        <div className="prose max-w-none" dangerouslySetInnerHTML={{ __html: materi.konten }} />
      </div>

      {/* Navigation Footer */}
      <div className="flex justify-between items-center mb-12 animate-fade-in-up animate-delay-200">
        {materi.urutan > 1 ? (

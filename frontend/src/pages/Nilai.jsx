        ...
        <>
          ...
          <div className="grid grid-cols-3 gap-5 mb-8">
            {[
              ...
              <div key={i} className="card p-5 text-center animate-fade-in-up" style={{ animationDelay: `${i * 0.08}s` }}>
          ...
          <div className="card overflow-hidden border-slate-200/60 shadow-sm animate-fade-in-up" style={{ animationDelay: '0.24s' }}>
            ...
            <div className="divide-y divide-slate-100/80">
              {nilaiList.map((n, idx) => {
                ...
                return (
                  <div key={idx} className="px-5 py-4.5 flex items-center justify-between hover:bg-slate-50/40 transition-colors animate-fade-in-up" style={{ animationDelay: `${(idx + 5) * 0.05}s` }}>
